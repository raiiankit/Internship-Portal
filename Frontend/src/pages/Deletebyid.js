      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-md shadow-md">
        ...
        <form onSubmit={handleSubmit(deleteUserById)} className="space-y-6">
          ...
          <div>
            <button
              type="submit"
              className="w-full px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Delete User
            </button>
          </div>
